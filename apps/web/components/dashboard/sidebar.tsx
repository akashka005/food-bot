...
const navItems = [
  ...
  { href: '/dashboard/stalls', icon: UtensilsCrossed, label: 'Browse Stalls' },
  ...
  { href: '/dashboard/whatsapp', icon: MessageCircle, label: 'WhatsApp Bot' },
];
      ...
      <div className="p-6 border-b border-border">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-display text-base font-bold">
            LPU <span className="gradient-text">SmartFood</span>
          </span>
        </Link>
      </div>
